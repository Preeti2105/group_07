    ...
    >
      <div className="container-fluid">
        ...
        <button
          ...
          data-bs-target="# navbar Example05"
          aria-controls="navbar Example05"
          aria-expanded="false"
        ...
        <div className="collapse navbar-collapse" id="navbar Example05">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <ul className="dropdown-menu" aria-labelled by="dropdown05">
